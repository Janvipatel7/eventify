...
<body>
    <main>
        <div class="login-page col-8 flex justify-center col-xl-9 col-lg-10 col-md-11 col-sm-12">
            <div class="login-content col-6 col-xl-7 col-lg-8 col-md-9 col-sm-12">
                <h1>SIGN IN</h1>
